...
[![GitHub License](https://img.shields.io/github/license/Tarunjit45/offer-bazar?style=flat-square)](LICENSE)
[![CI / Quality Check](https://github.com/Tarunjit45/offer-bazar/actions/workflows/ci.yml/badge.svg)](https://github.com/Tarunjit45/offer-bazar/actions)
[![Language](https://img.shields.io/badge/Language-JavaScript/TypeScript-blue?style=flat-square)](https://github.com/Tarunjit45/offer-bazar)
...
```bash
git clone https://github.com/Tarunjit45/offer-bazar.git
cd offer-bazar
```
